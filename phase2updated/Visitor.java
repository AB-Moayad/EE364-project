...
public abstract class Visitor {
    ...
    private ArrayList<Commutable> routeComponents = new ArrayList<>();
    private Commutable currentLocation;
    private int currentRouteComponentIndex;
    private int progressInCurrentLocation; // range [0, 100], 100 for completion
    private double progressRatio; // range [0.0, 1.0]
    private VisitorStatus status;
    private boolean completedPurpose;
    private int secondsSpentInHaram;
