...
public class Haram {
    ...
    Haram() {
         ...
         * 
         * ***** NOTES *****
         * Phase 1 : Showcase the visitors without organazation  
         * Phase 2 : Showcase the visitors with organazation
         * 
         * 
         * 
         * 
        ...
        for (String prayLocationName : defaultPrayLocationsNames) {
            prayLocations.add(new PrayLocation(prayLocationName, 65)); // 2 visitor capacity for testing
        }
        ...
        for (String pathwayName : defaultOuterPathways) {
            outerPathways.add(new Pathway(pathwayName, 50));
        }

        // initialize some inner pathways
        for (String pathwayName : defaultInnerPathways) {
            pathways.add(new Pathway(pathwayName, 50));
        }
        ...
        sahan = new Sahan("Tawaf Sahan", 7 * 100);
